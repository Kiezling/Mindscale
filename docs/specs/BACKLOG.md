...
- [ ] Descriptive sleep counts after active `SPEC-insights-onset-time-counts.md` — requires a separate bounded spec for night/nap classification, cross-range and open-sleep attribution, minimum samples, any post-wake window, and strict direction-of-effect language.
