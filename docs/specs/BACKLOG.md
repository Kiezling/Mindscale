...
- [ ] Remaining Insights views after the active `SPEC-insights-onset-gap-histogram.md` — onset-time counts with sample refusal/displacement caveat and descriptive sleep counts each require a separately approved bounded spec.
